module.exports = {
  plugin: {
    ...
    route: '/billing-view',
    description:
      'Billing View is a reconciliation dashboard that provides users with the transparency on how many orders were sent to SAP, billable, receiptable, etc',
    ...
    documentationUrl:
      'https://docs.google.com/document/d/1u9ryHAvvnLRJoduc18g6UrPnCqzwuXqXSpgHPewGkOQ/edit#heading=h.fsm1l96g7pa0',
